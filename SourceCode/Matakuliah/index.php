...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<br/>
	<a class="btn btn-info" href="tambah.php" role="button" >+ TAMBAH MATAKULIAH</a>
	<br/>
	<br/>
	<table class="table table-striped table-hover table-sm table-bordered">
		...
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit.php?id_mk=<?php echo $d['id_mk']; ?>"class="badge badge-success">EDIT</a>
					<a href="hapus.php?id_mk=<?php echo $d['id_mk']; ?>"class="badge badge-danger">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
