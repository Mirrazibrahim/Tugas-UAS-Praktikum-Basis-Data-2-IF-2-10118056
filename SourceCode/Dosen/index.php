...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<h2>DATA DOSEN</h2>
	<br/>
	<a class="btn btn-info" href="tambah.php" role="button" >+ TAMBAH DOSEN</a>
	<br/>
	<br/>
	<table class="table table-striped table-hover table-sm table-bordered">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"SELECT * from dosen, matakuliah where dosen.id_mk=matakuliah.id_mk");
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td>
					<a href="edit.php?id_dosen=<?php echo $d['id_dosen']; ?>"class="badge badge-success">EDIT</a>
					<a href="hapus.php?id_dosen=<?php echo $d['id_dosen']; ?>"class="badge badge-danger">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
