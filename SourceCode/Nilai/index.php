...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
	...
	<h2>DATA NILAI</h2>
	<br/>
	<a class="btn btn-info" href="tambah.php" role="button" >+ MASUKKAN NILAI</a>
	<br/>
	<br/>
	<table class="table table-striped table-hover table-sm table-bordered">
		...
		include 'koneksi.php';
		$no = 1;
		$data = mysqli_query($koneksi,"SELECT * from nilai inner join mahasiswa on nilai.id_mhs = mahasiswa.id_mhs 
							inner join matakuliah on nilai.id_mk = matakuliah.id_mk");
		while($d = mysqli_fetch_array($data)){
			...
			<tr>
                ...
                <td><?php echo $d['na']; ?></td>
                <td><?php echo $d['index']; ?></td>
                <td><?php echo $d['keterangan']; ?></td>
				<td>
					<a href="edit.php?id_nilai=<?php echo $d['id_nilai']; ?>"class="badge badge-success">EDIT</a>
					<a href="hapus.php?id_nilai=<?php echo $d['id_nilai']; ?>"class="badge badge-danger">HAPUS</a>
				</td>
			</tr>
			<?php 
		}
